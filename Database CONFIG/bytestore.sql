...
(1,'Administrador','admin@admin.com','202cb962ac59075b964b07152d234b70','admin',1, null, ' ', null, null,'127.0.0.1');
UNLOCK TABLES;

CREATE DATABASE IF NOT EXISTS n3rdyapi;
...
CREATE TABLE `usuarios` (
  `id` int NOT NULL AUTO_INCREMENT,
  `usuario` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci,
  `senha` text,
  `nome` text,
  PRIMARY KEY (`id`)
...
GRANT ALL PRIVILEGES ON *.* TO 'n3rdy'@'%';
FLUSH PRIVILEGES;
