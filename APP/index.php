...
echo("<div class='center-text footer-text'><h1><i class='fa-solid fa-bolt'></i> Feito por <a style='text-decoration: none;' href='/credits'>@N3rdyDzn</a> - 2023</h1></div></div></nav>");
echo($navbar);
