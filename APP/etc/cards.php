...
class card
{
    ...
    function CREATE_CARD($id, $title, $price, $discount, $img, $owner)
    {
        ...
        $actual_price = str_replace(".", ",", str_replace(",", ".", $actual_price));
        $parcel = str_replace(".", ",", str_replace(",", ".", $actual_price));
...
<div class="rounded-md drop-shadow-lg w-[11rem] bg-[#FDFDFD]">
    <a href="/anuncio/' . $id . '">
        <img src="../Assets/imgs/products/' . $img . '" alt="aaaaaa" class="rounded-t-md" title="aaaaa" />
        <div class="p-2 h-32">
