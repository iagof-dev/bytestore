        ...
        <div class="md:container w-full  flex flex-grow justify-end">
            <div class="grid grid-rows-1 grid-cols-2 items-center justify-end">
                <div class="grid-cols-1">
                    <a title="Criar anúncio" href="/create"><button class="w-10 font-semibold h-8 text-center leading-tight align-middle rounded-lg text-white bg-gradient-to-r from-cyan-500 to-blue-500 transition-colors duration-300 ease-in-out hover:bg-[#a0d4d6]">
                ...
                <div class="grid-cols-1">
                    ...
                    <div id="dropdown-menu-context" class="hidden absolute bg-[#FFFFFF] shadow-lg grid-rows-4 mt-2 ml-[-2rem] rounded">
