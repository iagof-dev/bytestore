...
$anuncios = get_5_random_products();
?>
...
<body>
  ...
  <div class="container-fluid text-center">
    <div style="margin-top:10px; margin-bottom: 3%;" style="padding-top: 5px;" class="container">
    ...
    <div class="col">
      ...
      <div class="comprados">
        <div class="row">
          <h1 style="font-size: 2vh !important; font-weight: bold; font-family: var(--fonte-montserrat) !important;">Mais Comprados:</h1>
        </div>
        <div class="row">
          <div class="center">
            <div style="margin-bottom: 10px;" class="row">
