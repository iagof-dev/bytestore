...
<div class="container">
    <div class="grid1">
      <div class="grid1-criaranuncios">
        <button class="btn btn-primary">Criar anuncio</button>
      </div>

      <div class="grid1-anuncios">
        <div class="center"><h1 style="font-size: 32px !important;">Anúncios:</h1></div><br>
        ...
        <div class="prod">
             <div class="prod-img">
              <img width="120px" src="https://cdn.discordapp.com/attachments/852640897505427466/1082029076337917992/keyboard-collage.png">
            </div>
            <div class="prod-info">
              ...
              <div class="prod-desc">
                  <p>Descrição do anuncio muito legal, nem parece falso, ok, é novo tals</p>
              </div>
            </div>
