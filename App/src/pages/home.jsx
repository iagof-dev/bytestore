  ...
  return (
    <div>
      ...
      <div className='md:container mx-auto w-[50%]'>
        <div className='w-full h-5 mx-auto bg-purple-900'>
          <div className="md:container w-full mt-1 bg-pink-600 flex flex-grow justify-center">
            <div className='grid grid-rows-1 grid-cols-5 grid-flow-col gap-5 items-center justify-center '>


              <div className=' rounded-md shadow-2xl w-[11rem] bg-gray-200'>
                ...
                <a href='/anuncio/x'><button className=' bg-[#00A000] rounded-sm text-white w-full h-10 rounded-b-md'>Adicionar ao carrinho</button></a>
              </div>
